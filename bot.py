#!/usr/bin/env python3
"""
DarkTunnel Config Extractor Bot v2.0
100% Working - No regex with newlines
"""
...
class DarkTunnelExtractor:
    ...
    def extract(self, content, filename="config.txt"):
        try:
            ...
            # Host - simple regex without newlines
            ...
            # Payload - using simple string find instead of regex with newlines
            payload = ""
            payload_start = content_str.find('[PAYLOAD]')
            if payload_start != -1:
                payload_section = content_str[payload_start + 9:]  # Skip '[PAYLOAD]'
...
def main():
    ...
    print("🔥 DarkTunnel Extractor Bot v2.0 Starting...")
