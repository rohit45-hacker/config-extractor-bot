#!/usr/bin/env python3
"""
Config Extractor Bot - Render Compatible v4.0
Python 3.14 compatible - Pure webhook method
"""
...
# Force compatible python-telegram-bot version
import telegram
...
⚡ <b>Powered by Python & Telegram Bot API</b>
    """
...
class HealthHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        response = {"status": "Bot is running!", "version": "4.0", "owner": OWNER_NAME}
...
def main():
    ...
    print("Starting Config Extractor Bot v4.0...")
